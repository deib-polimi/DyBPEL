   ...
   */
   public IAeDefReader getReader(AeBaseXmlDef aParentDef, QName aElementQName) throws UnsupportedOperationException
   {
      ...
      if (aParentDef != null)
      {
         ...
         //System.out.println("childReadersMap: "+ childReadersMap);
         if( childReadersMap != null )
         {
        	 
            reader = (IAeDefReader)childReadersMap.get(aElementQName);
           /* System.out.println("aElementQName: "+aElementQName);
            System.out.println("reader: "+reader);
            System.out.println("namespaceURI dentor la classe "+aElementQName.getNamespaceURI());
            System.out.println("localPart dentor la classe "+aElementQName.getLocalPart());
            */
           }
