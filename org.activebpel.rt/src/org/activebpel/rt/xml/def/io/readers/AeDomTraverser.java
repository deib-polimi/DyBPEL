...
public class AeDomTraverser
{
   ...
   public AeCommentIO getAeCommentIO()
   {
	   return mCommentIO;
   }
   /**
    ...
    * @throws AeException
    */
   public void traverseDefElement(AeBaseXmlDef aParentDef, Element aElement) throws AeException
   {
    ...
    * @throws AeException
    */
   public void traverseChildren( AeBaseXmlDef aDef, Element aElement )
   throws AeException
   {
