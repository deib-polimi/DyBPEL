// $Header: /gestionale/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/AeProcessDef.java,v 1.1 2009/09/23 13:09:28 zampognaro Exp $
/////////////////////////////////////////////////////////////////////////////
...
public class AeProcessDef extends AeScopeDef
{
   ...
   public void addMappings(IAeLocatableObject aObject)
   {
      if (aObject.hasCustomLocationPath())
      {
         ...
         {
        	 System.out.println();
        	 mLocationIdsToPaths.put(aObject.getLocationId(), aObject.getLocationPath());
        	 mLocationPathsToIds.put(aObject.getLocationPath(), new Integer(aObject.getLocationId()));
         }
      }
   }
