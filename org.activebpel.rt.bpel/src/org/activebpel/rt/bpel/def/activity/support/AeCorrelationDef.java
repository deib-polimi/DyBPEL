// $Header: /gestionale/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/activity/support/AeCorrelationDef.java,v 1.1 2009/09/23 13:09:05 zampognaro Exp $
/////////////////////////////////////////////////////////////////////////////
...
public class AeCorrelationDef extends AeBaseDef
{
   ...
   public static class AeCorrelationPatternType
   {
       ...
       * @param aValue
       */
      public AeCorrelationPatternType(String aValue)
      {
         mValue = aValue;
      }
