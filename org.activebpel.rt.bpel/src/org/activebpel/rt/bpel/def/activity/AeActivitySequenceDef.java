// $Header: /gestionale/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/activity/AeActivitySequenceDef.java,v 1.1 2009/09/23 13:09:48 zampognaro Exp $
/////////////////////////////////////////////////////////////////////////////
...
public class AeActivitySequenceDef extends AeActivityDef implements IAeMultipleActivityContainerDef
{
   ...
   /**
    * Returns a List of activity definitions to iterate over.
    * 
    * @return List over activity list
    */
   public List getActivityDefsList()
   {
      return mActivities;
   }
