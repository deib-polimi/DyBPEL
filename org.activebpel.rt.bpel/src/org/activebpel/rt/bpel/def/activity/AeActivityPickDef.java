// $Header: /gestionale/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/activity/AeActivityPickDef.java,v 1.1 2009/09/23 13:09:47 zampognaro Exp $
/////////////////////////////////////////////////////////////////////////////
...
public class AeActivityPickDef extends AeActivityDef implements IAeMessageContainerDef, IAeActivityCreateInstanceDef
{
   ...
   public void removeOnMessageDef(AeOnMessageDef aMessage)
   {
	   for(int i=0;i<=mOnMessageList.size();i++)
	   {
		   if(mOnMessageList.get(i).equals(aMessage))
		   {
		   		mOnMessageList.remove(i);
