// $Header: /gestionale/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/AeBaseDef.java,v 1.1 2009/09/23 13:09:28 zampognaro Exp $
/////////////////////////////////////////////////////////////////////////////
...
public abstract class AeBaseDef extends AeBaseXmlDef implements IAeBPELConstants
{
   ...
   public void accept(IAeBaseXmlDefVisitor aVisitor)
   {
      ...
      if (aVisitor instanceof IAeDefVisitor)
      {
         ...
         //System.out.println("---------------------- ramo if (faccio la set)---------");
      }
      else
      {
