// $Header: /gestionale/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/impl/AeAbstractBpelObject.java,v 1.1 2009/09/23 13:08:33 zampognaro Exp $
/////////////////////////////////////////////////////////////////////////////
      ...
      IAeNamespaceContext, IAeFunctionFactory
{
   ...
   protected AeAbstractBpelObject cloneParent(AeAbstractBpelObject object)
   {
	   
	  	object.mDef = this.mDef;
		object.mFault =this.mFault;
		object.mLocationId = this.mLocationId;
		object.mLocationPath = this.mLocationPath;
		object.mParent = this.mParent;
		object.mProcess= this.mProcess;
		object.mStartingTermination = this.mStartingTermination;
		object.mState= this.mState;
		object.mTerminating = this.mTerminating;
		return object;
	 }
