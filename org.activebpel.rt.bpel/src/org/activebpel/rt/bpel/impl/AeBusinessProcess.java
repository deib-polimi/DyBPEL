// $Header: /gestionale/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/impl/AeBusinessProcess.java,v 1.3 2009/12/09 16:11:47 zampognaro Exp $
/////////////////////////////////////////////////////////////////////////////
...
public class AeBusinessProcess extends AeActivityScopeImpl implements IAeBusinessProcessInternal, IAeVariableLockCallback, IAeVisitable
{
   ...
   /**
    * SLA@SOI:A copy of message that started the process.
    */
   private AeInboundReceive mCreateMessageCopy;
...
public Map getmLocationPathToId()
{
	return mLocationPathToId;
}
public AeIntMap getmLocationIdToPath()
{
	return mLocationIdToPath;
}
         ...
         throws AeBusinessProcessException
   {
      ...
      if (getCreateMessage() != null)
      {
         ...
         else if (messageQueueObject.matches( getCreateMessage() ))
         {
            ...
            //SLA@SOI: make a copy of create message
            mCreateMessageCopy = createMessage;
   ...
   public void queueInvoke(IAeInvokeActivity aInvoke, IAeMessageData aInputMessage,
         ...
         throws AeBusinessProcessException
   {
      AeInvoke messageQueueObject = createInvokeQueueObject(aInvoke, aInputMessage, aPartnerLink, aPartnerLinkKey, this);
   ...
   protected AeInvoke createInvokeQueueObject(IAeInvokeActivity aInvoke,
         IAeMessageData aInputMessage, IAePartnerLink aPartnerLink, AePartnerLinkOpImplKey aPartnerLinkKey, AeBusinessProcess businessProcess)
      throws AeBusinessProcessException
   {
      Map propertiesSnapshot = cloneBusinessProcessProperties();
    ...
    * @param aObject
    */
   public void addMappings(IAeLocatableObject aObject)
   {
    ...
    * ending.
    */
   public void processEnded(IAeFault aFault) throws AeBusinessProcessException
   {
    ...
    */
   public void terminationComplete() throws AeBusinessProcessException
   {
   ...
   /**
    * Returns a copy of the message that created the process.
    *
    * @return AeInboundReceive
    */
   public AeInboundReceive getCreateMessageCopy()
   {
      return mCreateMessageCopy;
   }
