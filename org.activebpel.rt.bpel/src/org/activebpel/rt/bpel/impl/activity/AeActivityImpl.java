// $Header: /gestionale/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/impl/activity/AeActivityImpl.java,v 1.1 2009/09/23 13:09:01 zampognaro Exp $
/////////////////////////////////////////////////////////////////////////////
...
abstract public class AeActivityImpl extends AeAbstractBpelObject implements IAeActivity
{
   ...
   protected AeAbstractBpelObject cloneParent(AeActivityImpl object)
   {
	   super.cloneParent(object);
	   object.mSourceLinks=this.mSourceLinks;
	   object.mTargetLinks=this.mTargetLinks;
	   object.mExtensions=this.mExtensions;
	   return object;
	 }
   /**
