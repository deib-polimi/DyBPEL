// $Header: /gestionale/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/impl/queue/AeInvoke.java,v 1.1 2009/09/23 13:09:52 zampognaro Exp $
/////////////////////////////////////////////////////////////////////////////
...
public class AeInvoke extends AeAbstractQueuedObject implements IAeInvokeInternal
{
   ...
   private AeBusinessProcess businessProcess;
   ...
   public AeInvoke(long aProcessId, QName aProcessName, IAePartnerLink aPartnerLink,
         ...
         IAeInvokeActivity aInvokeActivity, Map aProcessProperties, AeBusinessProcess businessProcess) throws AeBusinessProcessException
   {
   ...
   /**
    * Aggiunto questo metodo per recuperare la istanza del processo
    */
   public AeBusinessProcess getProcessInstance() {
