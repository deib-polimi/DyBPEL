// $Header: /gestionale/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/impl/AeBusinessProcessEngine.java,v 1.1 2009/09/23 13:08:29 zampognaro Exp $
/////////////////////////////////////////////////////////////////////////////
...
import it.eng.binding.impl.Binder;
...
public class AeBusinessProcessEngine implements IAeBusinessProcessEngineInternal, IAeBusinessProcessEngineCallback
{
   ...
   /**
    * Holds the binding information of the component services for all negotiated business process.  
    */
...
/**
   ...
   {
	  binder = Binder.init(); //Initializes the it.eng.binding.Binder
      mStarted = new Date();
   }
   
   /**
    * @return IBinderAdministration
    */
