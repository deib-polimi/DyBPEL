...
public interface IAeInvoke extends Serializable, IAeTransmission {
	...
	/**
	 * Accessor for the partner link (may be either a simple PL name or full
	 * location).
	 */
	...
	/**
	 * The <code>Map</code> of (string) name/value pairs that will be sent to
	 * the business process instance when the invoke is executed.
	 */
