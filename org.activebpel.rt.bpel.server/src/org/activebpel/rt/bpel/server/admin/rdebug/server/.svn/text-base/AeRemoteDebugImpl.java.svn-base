// $Header: /gestionale/org.activebpel.rt.bpel.server/src/org/activebpel/rt/bpel/server/admin/rdebug/server/AeRemoteDebugImpl.java,v 1.2 2009/11/30 15:13:39 zampognaro Exp $
/////////////////////////////////////////////////////////////////////////////
...
public class AeRemoteDebugImpl implements IAeBpelAdmin {
	...
	/**
	 * Map of context Id to engine listener used for dispatching remote debug
	 * events.
	 */
	private static Hashtable sEngineListeners = new Hashtable();

	/**
	 * Map of context Id to process listener used for dispatching remote debug
	 * events.
	 */
	private static Hashtable sProcessListeners = new Hashtable();

	/**
	 * Map of context Id to breakpoint listener used for dispatching remote
	 * debug events.
	 */
	 ...
	 * 
	 * @param aEventHandlerLocator
	 *            class name of locator for the event handler service routine
	 *            for BPEL engine events.
	 */
	...
	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#addPartnerRoleBindingRule(java.lang.String,
	 *      java.lang.String, IAeBindingRule)
	 */
	public void addPartnerRoleBindingRule(String aProcessID,
			String aPartnerRoleName, IAeBindingRule aBindingRule)
			throws RemoteException {
		AeEngineFactory.getEngine().getBinder().addPartnerRoleBindingRule(
				aProcessID, aPartnerRoleName, aBindingRule);
	}
	
	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#addPartnerRoleAbstractBindingRule(java.lang.String,
	 *      java.lang.String, IAeAbstractBindingRule)
	 */
	public void addPartnerRoleAbstractBindingRule(String aProcessID,
			...
			throws RemoteException {
		AeEngineFactory.getEngine().getBinder().addPartnerRoleAbstractBindingRule(
				aProcessID, aPartnerRoleName, aAbstractBindingRule);
	}

	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#removePartnerRoleRule(java.lang.String,
	 *      java.lang.String, java.util.Map)
	 */
	public void removePartnerRoleRule(String aProcessID,
			String aPartnerRoleName, Map aRuleCondition)
			throws RemoteException {
		AeEngineFactory.getEngine().getBinder().removePartnerRoleRule(
				aProcessID, aPartnerRoleName, aRuleCondition);
	}
	
	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#getPartnerRoleBindingRules(java.lang.String,
	 *      java.lang.String)
	 */
	public IAeBindingRule[] getPartnerRoleBindingRules(String aProcessID,
			String aPartnerRoleName) throws RemoteException {
		return AeEngineFactory.getEngine().getBinder().getPartnerRoleBindingRules(aProcessID, aPartnerRoleName);
	}
	
	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#getPartnerRoleAbstractBindingRules(java.lang.String,
	 *      java.lang.String)
	 */
	public IAeAbstractBindingRule[] getPartnerRoleAbstractBindingRules(String aProcessID,
			String aPartnerRoleName) throws RemoteException {
		return AeEngineFactory.getEngine().getBinder().getPartnerRoleAbstractBindingRules(aProcessID, aPartnerRoleName);
	}
	...
	public String getConfiguration() throws RemoteException, AeException {
		AeDefaultEngineConfiguration config = (AeDefaultEngineConfiguration) AeEngineFactory
				.getEngineConfig();
	...
	public void setConfiguration(String aXmlString) throws RemoteException,
		...
		AeDefaultEngineConfiguration config = (AeDefaultEngineConfiguration) AeEngineFactory
				.getEngineConfig();
		AeDefaultEngineConfiguration.loadConfig(config, AeUTF8Util
				.getInputStream(aXmlString), null);
		config.update();
	}

	/**
	 * Note this implementation will schhedule the suspend and wait up to 30
	 * seconds for the suspend to actually happen, this avoid deadlocks under
	 * rare occasions. But under normal circumstances the call will appear
	 * synchronous to client.
	 * 
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#suspendProcess(long)
	 */
	public void suspendProcess(long aPid) throws RemoteException,
		...
		try {
			...
			AeEngineFactory.getWorkManager().waitForAny(
					Collections.singleton(workItem), 30000);
		} catch (Exception e) {
			throw new AeBusinessProcessException(AeMessages.format(
					"AeRemoteDebugImpl.ERROR_0", new Long(aPid)), e); //$NON-NLS-1$
		}
	}
	 ...
	 */
	public void resumeProcess(long aPid) throws RemoteException,
			AeBusinessProcessException {
		try {
			...
			throw new AeBusinessProcessException(AeMessages.format(
					"AeRemoteDebugImpl.ERROR_1", new Long(aPid)), e); //$NON-NLS-1$
		}
	}
	 ...
	 * 
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#resumeProcessObject(long,
	 *      java.lang.String)
	 */
	public void resumeProcessObject(long aPid, String aLocation)
		...
		try {
			...
			args[1] = aLocation;
			throw new AeBusinessProcessException(AeMessages.format(
					"AeRemoteDebugImpl.ERROR_2", args), e); //$NON-NLS-1$ 
		}
	}
	 ...
	 */
	public void restartProcess(long aPid) throws RemoteException,
			AeBusinessProcessException {
		try {
			...
			throw new AeBusinessProcessException(AeMessages.format(
					"AeRemoteDebugImpl.ERROR_3", String.valueOf(aPid)), e); //$NON-NLS-1$
		}
	}
	 ...
	 */
	public void terminateProcess(long aPid) throws RemoteException,
			AeBusinessProcessException {
		try {
			...
			throw new AeBusinessProcessException(AeMessages.format(
					"AeRemoteDebugImpl.ERROR_4", new Long(aPid)), e); //$NON-NLS-1$
		}
	}

	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#addEngineListener(long,
	 *      java.lang.String)
	 */
	public void addEngineListener(long aContextId, String aEndpointURL)
			throws RemoteException {
		doAddEngineListener(aContextId, aEndpointURL);
	}

	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#addBreakpointListener(long,
	 *      java.lang.String,
	 *      org.activebpel.rt.bpel.server.admin.rdebug.server.AeBreakpointList)
	 */
	public void addBreakpointListener(long aContextId, String aEndpointURL,
			AeBreakpointList aBreakpointList) throws RemoteException {
		doAddBreakpointListener(aContextId, aEndpointURL, aBreakpointList);
	}

	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#updateBreakpointList(long,
	 *      java.lang.String,
	 *      org.activebpel.rt.bpel.server.admin.rdebug.server.AeBreakpointList)
	 */
	public void updateBreakpointList(long aContextId, String aEndpointURL,
			AeBreakpointList aBreakpointList) throws RemoteException {
		doUpdateBreakpointList(aContextId, aEndpointURL, aBreakpointList);
	}

	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#removeBreakpointListener(long,
	 *      java.lang.String)
	 */
	public void removeBreakpointListener(long aContextId, String aEndpointURL)
			throws RemoteException {
		doRemoveBreakpointListener(aContextId, aEndpointURL);
	}

	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#removeEngineListener(long,
	 *      java.lang.String)
	 */
	public void removeEngineListener(long aContextId, String aEndpointURL)
			throws RemoteException {
		doRemoveEngineListener(aContextId, aEndpointURL);
	}

	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#addProcessListener(long,
	 *      long, java.lang.String)
	 */
	public void addProcessListener(long aContextId, long aPid,
			String aEndpointURL) throws RemoteException {
		doAddProcessListener(aContextId, aPid, aEndpointURL);
	}

	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#removeProcessListener(long,
	 *      long, java.lang.String)
	 */
	public void removeProcessListener(long aContextId, long aPid,
			String aEndpointURL) throws RemoteException {
	...
	public AeProcessListResult getProcessList(AeProcessFilter aFilter)
			throws RemoteException {
		try {
			return AeEngineFactory.getEngineAdministration().getProcessList(
					aFilter);
		} catch (AeBusinessProcessException e) {
			throw new RemoteException(AeMessages
					.getString("AeRemoteDebugImpl.ERROR_5"), e); //$NON-NLS-1$
		}
	}
	 ...
	 */
	public AeProcessInstanceDetail getProcessDetail(long aPid)
			throws RemoteException {
	...
	public String getProcessState(long aPid) throws RemoteException {
		try {
			...
			throw new RemoteException(AeMessages
					.getString("AeRemoteDebugImpl.ERROR_6"), e); //$NON-NLS-1$
		}
	}
	...
	public byte[] getProcessDigest(long aProcessId) throws RemoteException {
		try {
			...
			String serverXML = AeXMLToSimpleString.extractCoreXML(
					new InputSource(new StringReader(input)), true);
			return AeUtil
					.getMessageDigest(AeUTF8Util.getInputStream(serverXML));
		} catch (Exception e) {
			throw new RemoteException(AeMessages
					.getString("AeRemoteDebugImpl.ERROR_7"), e); //$NON-NLS-1$
		}
	}
	...
	public String getProcessDef(long aProcessId) throws RemoteException {
		try {
			...
			throw new RemoteException(AeMessages
					.getString("AeRemoteDebugImpl.ERROR_8"), e); //$NON-NLS-1$
		}
	}
	 ...
	 */
	protected IAeProcessDeployment findDeploymentPlan(long aProcessId)
			throws AeBusinessProcessException {
		QName processName = AeEngineFactory.getEngine().getProcessManager()
				.getProcessQName(aProcessId);
		IAeProcessDeployment deployment = AeEngineFactory
				.getDeploymentProvider().findDeploymentPlan(aProcessId,
						processName);
		return deployment;
	}
	...
	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#getVariable(long,
	 *      java.lang.String)
	 */
	public String getVariable(long aPid, String aVariablePath)
			throws RemoteException {
		try {
			Document doc = AeEngineFactory.getEngine().getProcessVariable(aPid,
					aVariablePath);
			return AeXMLParserBase.documentToString(doc, true);
		} catch (AeBusinessProcessException e) {
			throw new RemoteException(AeMessages
					.getString("AeRemoteDebugImpl.ERROR_9"), e); //$NON-NLS-1$
		}
	}

	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#setVariable(long,
	 *      java.lang.String, java.lang.String)
	 */
	public String setVariable(long aPid, String aVariablePath,
			String aVariableData) throws RemoteException {
		try {
			...
			AeEngineFactory.getEngine().setVariableData(aPid, aVariablePath,
					doc);
			return ""; // success indicator //$NON-NLS-1$
		} catch (Throwable e) {
			throw new RemoteException(AeMessages
					.getString("AeRemoteDebugImpl.ERROR_SettingVariable"), e); //$NON-NLS-1$
		}
	}

	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#addAttachment(long,
	 *      java.lang.String, org.activebpel.wsio.AeWebServiceAttachment)
	 */
	public AeAddAttachmentResponse addAttachment(long aPid,
			String aVariablePath, AeWebServiceAttachment aWsioAttachment)
			throws RemoteException, AeBusinessProcessException {
		try {
			IAeAttachmentItem addedItem = AeEngineFactory
					.getEngine()
					.addVariableAttachment(aPid, aVariablePath, aWsioAttachment);

			AeAddAttachmentResponse response = new AeAddAttachmentResponse();
			response.setAttachmentId(addedItem.getAttachmentId());
			response
					.setAttachmentAttributes(convertAttachmentAttributes(addedItem
							.getHeaders()));
			return response;

		} catch (Throwable e) {
			throw new RemoteException(AeMessages
					.getString("AeRemoteDebugImpl.ERROR_AddingAttachment"), e); //$NON-NLS-1$
		}
	}
	 ...
	 */
	protected static AeAttachmentAttributeList convertAttachmentAttributes(
			Map aMap) {
		// Convert attribute map to AeAttachmentAttributeList
		AeAttachmentAttribute tgtAttributes[] = new AeAttachmentAttribute[aMap
				.size()];
		int i = 0;
	...
	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#removeAttachments(long,
	 *      java.lang.String, int[])
	 */
	public String removeAttachments(long aPid, String aVariablePath,
			int[] aAttachmentItemNumbers) throws RemoteException,
			AeBusinessProcessException {
		AeEngineFactory.getEngine().removeVariableAttachments(aPid,
				aVariablePath, aAttachmentItemNumbers);
		return ""; //$NON-NLS-1$
	}
	...
	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#deployBpr(java.lang.String,
	 *      java.lang.String)
	 */
	...
	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#setPartnerLinkData(long,
	 *      boolean, java.lang.String, java.lang.String)
	 */
	public void setPartnerLinkData(long aPid, boolean aIsPartnerRole,
			String aLocationPath, String aData) throws RemoteException {
		try {
			AeXMLParserBase parser = new AeXMLParserBase(true, false);
			Document doc = parser.loadDocumentFromString(aData, null);

			AeEngineFactory.getEngine().setPartnerLinkData(aPid,
					aIsPartnerRole, aLocationPath, doc);
		} catch (AeException e) {
			throw new RemoteException(AeMessages
					.getString("AeRemoteDebugImpl.ERROR_10"), e); //$NON-NLS-1$
		}
	}

	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#setCorrelationSetData(long,
	 *      java.lang.String, java.lang.String)
	 */
	public void setCorrelationSetData(long aPid, String aLocationPath,
			String aData) throws RemoteException {
		try {
			AeXMLParserBase parser = new AeXMLParserBase();
			Document doc = parser.loadDocumentFromString(
					"<CorrSetProps>" + aData + "</CorrSetProps>", null); //$NON-NLS-1$//$NON-NLS-2$

			Map corrSetData = AeCorrelationSet.convertCorrSetDataToMap(doc);
			if (corrSetData.size() > 0)
				AeEngineFactory.getEngine().setCorrelationData(aPid,
						aLocationPath, corrSetData);
		} catch (AeException e) {
			throw new RemoteException(AeMessages
					.getString("AeRemoteDebugImpl.ERROR_11"), e); //$NON-NLS-1$
		}
	}

	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#retryActivity(long,
	 *      java.lang.String, boolean)
	 */
	public void retryActivity(long aPid, String aLocationPath, boolean aAtScope)
			throws RemoteException, AeBusinessProcessException {
		AeEngineFactory.getEngine()
				.retryActivity(aPid, aLocationPath, aAtScope);
	}

	/**
	 * @see org.activebpel.rt.bpel.server.admin.rdebug.server.IAeBpelAdmin#completeActivity(long,
	 *      java.lang.String)
	 */
	public void completeActivity(long aPid, String aLocationPath)
			throws RemoteException, AeBusinessProcessException {
	...
	/**
	 * Returns the key to use for locating listeners given the contextId and
	 * endpoint URL.
	 * 
	 * @param aContextId
	 *            The context id
	 * @param aEndpointURL
	 *            The URL of the administrative web service
	 */
	 ...
	 * 
	 * @param aContextId
	 *            the context id used to locate the callback
	 * @param aEndpointURL
	 *            The endpoint reference of the listener
	 * @throws RemoteException
	 */
	public static void doAddEngineListener(long aContextId, String aEndpointURL)
			throws RemoteException {
		// In case this is already registered deregister first
		doRemoveEngineListener(aContextId, aEndpointURL);

		// Register new listener
		IAeEngineListener listener = new AeEngineListener(aContextId,
				aEndpointURL);
	 ...
	 * @throws RemoteException
	 */
	public static void doRemoveEngineListener(long aContextId,
			String aEndpointURL) throws RemoteException {
		IAeEngineListener listener = (IAeEngineListener) sEngineListeners
				.remove(getKey(aContextId, aEndpointURL));
		if (listener != null)
			AeEngineFactory.getEngine().removeEngineListener(listener);
	}

	/**
	 * Add a listener to those notified of process events for the given process
	 * ID.
	 * 
	 * @param aContextId
	 *            the context id used to locate the callback
	 * @param aPid
	 *            the process id we are being installed for
	 * @param aEndpointURL
	 *            The endpoint reference of the listener
	 * @throws RemoteException
	 */
	public static void doAddProcessListener(long aContextId, long aPid,
			String aEndpointURL) throws RemoteException {
		// In case this is already registered deregister first
		doRemoveProcessListener(aContextId, aPid, aEndpointURL);

		// Register new listener
		IAeProcessListener listener = new AeProcessListener(aContextId, aPid,
				aEndpointURL);
	 ...
	 *            the context id used to locate the callback
	 * @param aPid
	 *            the process id we are being removed for
	 * @param aEndpointURL
	 *            The endpoint reference of the listener
	 * @throws RemoteException
	 */
	public static void doRemoveProcessListener(long aContextId, long aPid,
			String aEndpointURL) throws RemoteException {
		IAeProcessListener listener = (IAeProcessListener) sProcessListeners
				.remove(getKey(aContextId, aEndpointURL));
		if (listener != null)
	 ...
	 * @param aEndpointURL
	 *            The endpoint reference of the listener
	 * @param aBreakpointList
	 *            The list of breakpoints.
	 * @throws RemoteException
	 */
	public static void doAddBreakpointListener(long aContextId,
			String aEndpointURL, AeBreakpointList aBreakpointList)
			throws RemoteException {
		// In case this is already registered deregister first
		doRemoveBreakpointListener(aContextId, aEndpointURL);

		// Register new listener
		AeBreakpointListener listener = new AeBreakpointListener(aContextId,
				aEndpointURL, aBreakpointList);
	 ...
	 * @throws RemoteException
	 */
	public static void doRemoveBreakpointListener(long aContextId,
			String aEndpointURL) throws RemoteException {
		AeBreakpointListener listener = (AeBreakpointListener) sBreakpointListeners
				.remove(getKey(aContextId, aEndpointURL));
		if (listener != null)
	 ...
	 *            The list of breakpoints.
	 */
	public static void doUpdateBreakpointList(long aContextId,
			String aEndpointURL, AeBreakpointList aBreakpointList)
			throws RemoteException {
		AeBreakpointListener listener = (AeBreakpointListener) sBreakpointListeners
				.get(getKey(aContextId, aEndpointURL));
		if (listener != null)
			listener.updateBreakpointList(aBreakpointList);
	}

	/**
	 * Returns an instance of the configured event handler service locator
	 * class.
	 * 
	 * @param aEndpointURL
	 *            the endpoint events that will be dispatched through.
	 * @return IAeEvenHandlerService
	 * @throws AeBusinessProcessException
	 */
	protected static IAeEventHandlerService getEventHandlerServiceLocator(
			String aEndpointURL) throws AeBusinessProcessException {
		if (AeUtil.isNullOrEmpty(sEventHandlerLocator))
			throw new AeBusinessProcessException(AeMessages
					.getString("AeRemoteDebugImpl.ERROR_12")); //$NON-NLS-1$

		try {
			Class c = Class.forName(sEventHandlerLocator);
			Constructor constructor = c
					.getConstructor(new Class[] { String.class });
			return (IAeEventHandlerService) constructor
					.newInstance(new Object[] { aEndpointURL });
		} catch (Exception e) {
			throw new AeBusinessProcessException(MessageFormat.format(
					AeMessages.getString("AeRemoteDebugImpl.ERROR_13"), //$NON-NLS-1$
					new Object[] { sEventHandlerLocator }), e);
		}
	}

	/**
	 * Base class for our work involving calls into the engine that affect a
	 * process.
	 */
	protected static abstract class AeRemoteWork extends AeAbstractWork {
		...
		/**
		 * error message to include along with any raised exception during the
		 ...
		 * 
		 * @param aPid
		 *            the process id used by work
		 * @param aErrorMessage
		 *            error message to include in addition to a caught exception
		...
		public void run() {
			try {
				...
				// All of the subclasses have a placeholder in their error
				// messages
				// for the process id
				Object[] args = new Object[1];
				args[0] = new Long(getPid());
				String errorMessage = MessageFormat.format(getErrorMessage(),
						args);
		...
		/**
		 * Subclasses need to override in order to make their call into the
		 * engine.
		 * 
		 * @throws AeBusinessProcessException
		 */
	...
	protected static class AeRemoteResumeObjectWork extends AeRemoteWork {
		 ...
		 *            The process id to resume.
		 * @param aPath
		 *            the path of the object to resume.
		 */
	...
	/**
	 * The process listener stub which will forward events to the remote event
	 * handler.
	 */
	protected static class AeProcessListener implements IAeProcessListener {
		 ...
		 * 
		 * @param aContextId
		 *            the context id of the remote engine
		 * @param aProcessId
		 *            the process Id we are handling events for
		 * @param aEndpointURL
		 *            the endpoint events will be dispatched through
		 */
		public AeProcessListener(long aContextId, long aProcessId,
				String aEndpointURL) throws RemoteException {
			try {
				mContextId = aContextId;
				mProcessId = aProcessId;
				mEndpointURL = aEndpointURL;
				mHandler = AeRemoteDebugImpl.getEventHandlerServiceLocator(
						aEndpointURL).getRemoteDebugService();
			} catch (Exception e) {
				throw new RemoteException(AeMessages
						.getString("AeRemoteDebugImpl.ERROR_22"), e); //$NON-NLS-1$
			}
		}
		...
		public boolean handleProcessEvent(IAeProcessEvent aEvent) {
			...
			try {
				if (mHandler != null) {
					suspend = mHandler.processEventHandler(mContextId, aEvent
							.getPID(), aEvent.getNodePath(), aEvent
							.getEventID(), aEvent.getFaultName(), aEvent
							.getAncillaryInfo(), aEvent.getQName(), aEvent
							.getTimestamp());
				}
			} catch (RemoteException re) {
				AeException.logError(re, AeMessages
						.getString("AeRemoteDebugImpl.ERROR_23")); //$NON-NLS-1$

				try {
					AeRemoteDebugImpl.doRemoveProcessListener(mContextId,
							mProcessId, mEndpointURL);
				} catch (RemoteException e) {
					AeException.logError(e, AeMessages
							.getString("AeRemoteDebugImpl.ERROR_24")); //$NON-NLS-1$
				}
			}
			return suspend;
		}
		...
		public void handleProcessInfoEvent(IAeProcessInfoEvent aEvent) {
			try {
				if (mHandler != null) {
					mHandler.processInfoEventHandler(mContextId, aEvent
							.getPID(), aEvent.getNodePath(), aEvent
							.getEventID(), aEvent.getFaultName(), aEvent
							.getAncillaryInfo(), aEvent.getTimestamp());
				}
			} catch (RemoteException re) {
				AeException.logError(re, AeMessages
						.getString("AeRemoteDebugImpl.ERROR_23")); //$NON-NLS-1$
	...
	/**
	 * The engine listener implementation which will forward events to the
	...
	protected static class AeEngineListener implements IAeEngineListener {
		 ...
		 *            the endpoint events will be dispatched through
		 */
		public AeEngineListener(long aContextId, String aEndpointURL)
				throws RemoteException {
			try {
				mContextId = aContextId;
				mEndpointURL = aEndpointURL;
				...
				throw new RemoteException(AeMessages
						.getString("AeRemoteDebugImpl.ERROR_25"), e); //$NON-NLS-1$
			}
		}
		...
		public void handleAlert(IAeEngineAlert aEvent) {
			try {
				if (mHandler != null) {
					mHandler.engineAlertHandler(mContextId, aEvent.getPID(),
							aEvent.getEventID(), aEvent.getProcessName(),
							aEvent.getLocation(), aEvent.getFaultName(), aEvent
									.getDetails(), aEvent.getTimestamp());
				}
			} catch (RemoteException re) {
				AeException.logError(re, AeMessages
						.getString("AeRemoteDebugImpl.ERROR_26")); //$NON-NLS-1$

				try {
					AeRemoteDebugImpl.doRemoveEngineListener(mContextId,
							mEndpointURL);
				} catch (RemoteException e) {
					AeException.logError(e, AeMessages
							.getString("AeRemoteDebugImpl.ERROR_24")); //$NON-NLS-1$
		...
		public boolean handleEngineEvent(IAeEngineEvent aEvent) {
			try {
				if (mHandler != null) {
					return mHandler.engineEventHandler(mContextId, aEvent
							.getPID(), aEvent.getEventID(), aEvent
							.getProcessName(), aEvent.getTimestamp());
				}
			} catch (RemoteException re) {
				AeException.logError(re, AeMessages
						.getString("AeRemoteDebugImpl.ERROR_26")); //$NON-NLS-1$
	...
	/**
	 * This is the global process listener stub which will forward breakpoint
	 * events to the remote event handler.
	 * 
	 * Technically, this class listens globally for <i>process</i> events that
	 * indicate a breakpoint may have been hit. A test is performed and if so,
	 * an actual breakpoint event is generated.
	 */
	protected static class AeBreakpointListener implements IAeProcessListener {
		 ...
		 * endpoint URL to dispatch breakpoint events to and a list of
		 * breakpoints to monitor.
		 * 
		 * @param aContextId
		 *            the context id of the remote engine
		 * @param aEndpointURL
		 *            the endpoint breakpoint events will be dispatched through
		 * @param aBreakpointList
		 *            the list of breakpoints to be monitored.
		 */
		public AeBreakpointListener(long aContextId, String aEndpointURL,
				AeBreakpointList aBreakpointList) throws RemoteException {
			try {
				mContextId = aContextId;
				mEndpointURL = aEndpointURL;
				...
				throw new RemoteException(AeMessages
						.getString("AeRemoteDebugImpl.ERROR_28"), e); //$NON-NLS-1$
			}
		}
		 ...
		 * 
		 * @param aBreakpointList
		 *            the new list of breakpoints.
		 */
		public void updateBreakpointList(AeBreakpointList aBreakpointList) {
			if (aBreakpointList == null
					|| aBreakpointList.getTotalRowCount() <= 0) {
				mBreakpointList = null;
			} else {
				HashMap breakpointList = new HashMap();
				for (int i = 0; i < aBreakpointList.getTotalRowCount(); i++) {
					AeBreakpointInstanceDetail detail = aBreakpointList
							.getRowDetails()[i];
					if (!AeUtil.isNullOrEmpty(detail.getNodePath())
							&& !AeUtil.isNullOrEmpty(detail.getProcessName()
									.toString())) {
						breakpointList.put(AeLocationPathUtils
								.removeInstanceInfo(detail.getNodePath())
								+ detail.getProcessName().toString(), detail);
					}
				}
		...
		public boolean handleProcessEvent(IAeProcessEvent aEvent) {
			try {
				...
				if (mHandler != null
						&& aEvent.getEventID() == IAeProcessEvent.READY_TO_EXECUTE) {
					// Getting ready to execute - see if there's a breakpoint
					// set for this node path.
					if (mBreakpointList != null
							&& mBreakpointList.get(AeLocationPathUtils
									.removeInstanceInfo(aEvent.getNodePath())
									+ aEvent.getQName().toString()) != null) {
						// First suspend the process locally.
						AeEngineFactory.getEngine().suspendProcess(
								aEvent.getPID());

						// Then dispatch a breakpoint event based on this RTE
						// event.
						final IAeProcessEvent event = aEvent;
						AeEngineFactory.getWorkManager().schedule(
								new AeAbstractWork() {
									public void run() {
										try {
											mHandler.breakpointEventHandler(
													mContextId, event.getPID(),
													event.getNodePath(), event
															.getQName(), event
															.getTimestamp());
										} catch (RemoteException e) {
											AeBusinessProcessException
													.logError(
															...
															AeMessages
																	.format(
																			"AeRemoteDebugImpl.ERROR_33", new Long(event.getPID()))); //$NON-NLS-1$
											...
											try {
												...
												AeException
														.logError(
																...
																AeMessages
																		.format(
																				"AeRemoteDebugImpl.ERROR_1", new Long(event.getPID()))); //$NON-NLS-1$
											}

											try {
												AeRemoteDebugImpl
														.doRemoveBreakpointListener(
																mContextId,
																mEndpointURL);
											} catch (Throwable th) {
												AeException
														.logError(
																th,
																AeMessages
																		.getString("AeRemoteDebugImpl.ERROR_30")); //$NON-NLS-1$
											}
										}
									}
								});
				...
				AeException
						.logError(
								...
								AeMessages
										.format(
												"AeRemoteDebugImpl.ERROR_31", new Long(aEvent.getPID()))); //$NON-NLS-1$
			}
